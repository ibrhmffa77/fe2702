// 'Mən Turing Academydə Programing tədrisi alıram' cümləsində neçə hərf olduğunu consolda yazdırın.
...
//     return obj
// }
// console.log(getCountLetter(words))
const data = [
    {
    "id": 10271,
    "customerId": "SPLIR",
...
for(let i=0; i<data.length; i++){
    if(data[i].employeeId===6){
        console.log(data[i].shipAddress)
    }
}
